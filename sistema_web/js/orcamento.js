...
function renderizarTabelaItens() {
  ...
  currentItems.forEach((item, index) => {
    ...
    tr.innerHTML = `
      ...
      <td>
        <input type="number" step="0.1" class="table-input tabular-nums" style="text-align: right; font-weight: 700;" value="${item.quantity}" oninput="atualizarItem(${index}, 'quantity', this.value)">
      </td>
      <td>
        <input type="text" class="table-input" style="text-align: center; text-transform: lowercase;" value="${escapeHtml(item.unit || 'un')}" oninput="atualizarItem(${index}, 'unit', this.value)">
      </td>
      <td>
        <input type="number" step="0.5" class="table-input tabular-nums" style="text-align: right;" value="${item.unit_cost}" oninput="atualizarItem(${index}, 'unit_cost', this.value)">
      </td>
      <td style="font-weight: 800; color: var(--orange-600); font-size: 13.5px; text-align: right;" class="tabular-nums">
